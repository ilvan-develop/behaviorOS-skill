...
## Identity
You are an AI agent working on **my-project**, a My project application governed by the behaviorOS framework.

## Project Context
* Name: my-project
* Domain: My project
* Stack: TypeScript
* Governance: behaviorOS (7 phases)
...
| architect | Architecture decisions, design reviews | 7 |
| planner | Task breakdown, sprint planning | 7 |
| backend | APIs, business logic, integrations | 7 |
| frontend | UI components, user experience | 7 |
| database | Schema, migrations, queries | 7 |
| qa | Testing, quality assurance | 7 |
| security | Security audits, vulnerability checks | 7 |
| devops | CI/CD, deployment, infrastructure | 7 |
| compliance | Regulatory compliance, audit trails | 7 |
